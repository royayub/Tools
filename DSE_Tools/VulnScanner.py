...
# ===== #
# Websites: dse.myvnc.com
# Author: Muhammad Ayub | Sidra Irum | Muaaz Ali
# GitHub: https://github.com/royayub
# linkedin: https://www.linkedin.com/in/royayub/
# Facebook: https://web.facebook.com/elitehacker5
# Twitter: https://twitter.com/roy_ayub
# Tryhackme: hhttps://tryhackme.com/p/royayub086
# ===== #

# ===== #
# Created June 2021 | Copyright (c) 2021 - 2022
# Update June 2021
# ===== #
...
.||.....|  '|.' .||. ||. .||.  '|...' '|..'|' .||. .||.  .||. '|..'|'  '|...' .||. ||. .||. .||. ||.  '||||. .||.  .||.  '|..'|.  '|...'  
                                                                                                     .|....'                              
            \033[1;m
        \033[34mCodeFight - Information Gathering Tool \033[0m
        \033[34mAuthor: Muhammad Ayub \033[0m
        \033[34mGithub:  https://github.com/royayub \033[0m
        \033[34mWebsite: http://dse.myvnc.com \033[0m
...
def fun():
    ...
    while choice != ("12"):
        ...
        if choice == ("3"):
            ...
            time.sleep(1)
            print("\n\t\033[34mDefensive Security Experts\033[0m DONE... Exiting... \033[34mLike to See Ya Hacking Anywhere ..!\033[0m\n")
            sys.exit()
